...
from scratch to the contract in Part III of `docs/Plan_PULSE_engine_and_assets.txt`
...
See Part III section 1 for the full asset contract (orientation, scale, texel density tiers,
naming) and section 6 for the verify loop.
